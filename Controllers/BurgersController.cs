...
namespace JuanAraujoTallerMVC.Controllers
{
    public class BurgersController : Controller
    {
        private readonly JuanAraujoTallerMVCContext _context;

        public BurgersController(JuanAraujoTallerMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'JuanAraujoTallerMVCContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JuanAraujoTallerMVCContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
